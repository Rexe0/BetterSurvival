...
public class CalmingBobber extends Item {
    public CalmingBobber() {
        super(Material.GHAST_TEAR, ChatColor.GREEN+"Calming Bobber", "CALMING_BOBBER");
    }
    ...
    public List<String> getLore() {
        ...
        lore.add(ChatColor.GRAY+"Reduces the chance of pulling");
        lore.add(ChatColor.GRAY+"up hostile mobs while fishing");
        lore.add(ChatColor.GRAY+"in the nether.");
        return lore;
    }
