...
public enum WineType {
    ...
    BEER(ChatColor.YELLOW, "Beer", "Bitter", Material.WHEAT, 16, Color.fromRGB(255, 175, 36)),
    SUGAR_WASH(ChatColor.WHITE, "Sugar Wash", "Very Sweet", Material.SUGAR, 2, Color.fromRGB(255, 230, 186));
    ...
    WineType(ChatColor nameColor, String name, String flavorName, Material fruit, int fruitCost) {
        this(nameColor, name, flavorName, fruit, fruitCost, Color.fromRGB(173, 14, 40));
    }
